          ...
          <TableBody>
            <TableRow className="h-[72px] rounded-sm box_shadow font-medium">
              <TableCell className="pl-4 max-sm:pl-0">
                <div className="flex items-center">
                  <Image
                    src={"/assets/shop12.svg"}
                    alt="no img found"
                    width={40}
                    height={40}
                  ></Image>
                  <h2 className="pl-4 max-sm:pl-1 max-sm:pr-2">Burger</h2>
                </div>
              </TableCell>
            ...
            <TableRow className="h-[72px] rounded-sm box_shadow font-medium">
              <TableCell className="pl-4 max-sm:pl-0">
                <div className="flex items-center">
                  <Image
                    src={"/assets/shop14.svg"}
                    alt="no img found"
                    width={40}
                    height={40}
                  ></Image>
                  <h2 className="pl-4 max-sm:pl-1 max-sm:pr-2">
                    Chocolate Muffin
                  </h2>
                </div>
              </TableCell>
